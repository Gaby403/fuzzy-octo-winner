...
/**
 * Modal de detalhe do projeto. Vive em módulo próprio e é carregado sob
 * demanda (React.lazy): são ~420 linhas que só fazem falta quando alguém
 * abre um projeto, e não no primeiro carregamento da home.
 */
