/** Ícones de linha para as etapas do processo. Chaveados pelo `icon` do CMS. */
export function ProcessIcon({ name, size = 28, color = "currentColor" }: { name: string; size?: number; color?: string }) {
