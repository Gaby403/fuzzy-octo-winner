...
// Sob demanda: o modal de projeto (~420 linhas) e a página /projetos só são
// baixados quando alguém realmente abre um projeto ou a listagem completa.
...
function ProjectsSection() {
  ...
  return (
    ...
    <AnimatePresence>
      {selectedProj && (
        <Suspense fallback={null}><ProjectDetail key={selectedProj.id} proj={selectedProj} onClose={handleClose} onPrev={handlePrev} onNext={handleNext} /></Suspense>
      )}
    </AnimatePresence>
