...
export const DICT = {
    ...
    "menu.projetos": { pt: "Projetos", en: "Work" },
    "menu.sobre": { pt: "Sobre", en: "About" },
    "menu.blog": { pt: "Blog", en: "Blog" },
    "menu.contato": { pt: "Contato", en: "Contact" },

    "idioma.aviso": { pt: "Este site também está disponível em português.", en: "This site is also available in English." },
    "idioma.acao": { pt: "Ver em português", en: "View in English" },
    "idioma.dispensar": { pt: "Dispensar aviso", en: "Dismiss notice" },
    ...
    "blog.tituloPagina": { pt: "BLOG", en: "BLOG" },
    "blog.destaquePagina": { pt: "& IDEIAS.", en: "& IDEAS." },
    "blog.subtitulo": { pt: "Estratégia, design e tecnologia — o que aprendemos construindo presença digital.", en: "Strategy, design and technology — what we learn building digital presence." },
    "blog.buscarNo": { pt: "Buscar no blog", en: "Search the blog" },
    "blog.botaoBuscar": { pt: "Buscar", en: "Search" },
    "blog.erro": { pt: "Não foi possível carregar o blog agora. Tente novamente em instantes.", en: "We couldn't load the blog right now. Please try again in a moment." },
    "blog.paginacao": { pt: "Paginação", en: "Pagination" },
    "blog.pagina": { pt: "Página", en: "Page" },
    "blog.indice": { pt: "Índice do artigo", en: "Article outline" },
    "blog.leiaTambem": { pt: "Leia também", en: "Read next" },
    ...
    "servico.ver": { pt: "Ver serviço", en: "View service" },
    "servico.inexistente": { pt: "Não existe ou foi removido o serviço", en: "No such service, or it has been removed:" },
    ...
    "sobre.etapas": { pt: "ETAPAS", en: "STEPS" },
    "sobre.conversar": { pt: "Vamos conversar", en: "Let's talk" },

    "pagina.inexistente": { pt: "Não existe ou não está publicada no WordPress a página", en: "No such page, or it isn't published in WordPress:" },
    ...
    "processo.titulo": { pt: "Processo", en: "Process" },

    "obrigado.inicio": { pt: "VOLTAR AO INÍCIO", en: "BACK TO HOME" },
    "obrigado.projetos": { pt: "VER PROJETOS", en: "VIEW WORK" },

    "erro.404": { pt: "Página não encontrada", en: "Page not found" },
    "erro.voltarHome": { pt: "← Voltar para a home", en: "← Back to home" },
    "erro.voltar": { pt: "Voltar para a home", en: "Back to home" },
    "erro.texto": { pt: "A página que você procura mudou de lugar ou nunca existiu. Toda jornada tem desvios — vamos te levar de volta ao caminho.", en: "The page you're looking for has moved, or never existed. Every journey has detours — let's get you back on the path." },
    "erro.linksUteis": { pt: "Links úteis", en: "Useful links" },
} as const;
