...
export default function Admin() {
    ...
    return (<div style={{
      ...
      <a href={WP_ADMIN_URL} style={{ background: RED, color: WHITE, textDecoration: "none", fontWeight: 700, fontSize: 12, letterSpacing: "0.12em", padding: "13px 22px", borderRadius: 8 }}>
